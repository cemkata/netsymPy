...
function setAction(name){
	switch(name){
		...
		case 'ClearRules': document.getElementsByName("exsecutionAction")[0].value='ClearRules'; break;
		case 'ShowRules': document.getElementsByName("exsecutionAction")[0].value='ShowRules'; break;
		case 'Status': document.getElementsByName("exsecutionAction")[0].value='Status'; break;
